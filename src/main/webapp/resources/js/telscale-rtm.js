...
function enableCommunicatePanel(localAudioVideoMediaStream) {
	...
	//window.location.href = window.location.protocol + '//' + window.location.hostname + ':' + window.location.port + '/' + window.location.pathname + '#/room';
}
...
function enableCallButton(contact) {
	//document.getElementById("Call").disabled = false;
	$("#call"+contact).show();	
	$("#audioCall"+contact).show();	
}

function disableCallButton(contact,videoCall) {
	//document.getElementById("Call").disabled = true;
	$("#call"+contact).hide();
	$("#audioCall"+contact).hide();
}

function enableEndCallButton(contact,videoCall) {
	//document.getElementById("Bye").disabled = false;
	if(videoCall) {
		$("#endCall"+contact).show();
	} else {
		$("#endAudioCall"+contact).show();
	}
	$("#callStatus"+contact).show();
	$("#dialPad"+contact).show();
}

function disableEndCallButton(contact) {
	//document.getElementById("Bye").disabled = true;
	$("#endCall"+contact).hide();
	$("#endAudioCall"+contact).hide();
	$("#callStatus"+contact).hide();
	$("#dialPad"+contact).hide();
}
