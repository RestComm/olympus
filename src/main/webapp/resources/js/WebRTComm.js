        ...
        if (this.webRTCommMessage.webRTCommCall.eventListener.onWebRTCommMessageReceivedEvent)
        {
            ...
            setTimeout(function() {
                try {
                    ...
                    console.error("PrivateJainSipClientConnector:onJainSipClientConnectorSipRequestEvent(): catched exception in event listener:"); console.log(exception);
                }
            }, 1);
        }
    }
                ...
                if (this.webRTCommMessage.webRTCommCall.eventListener.onWebRTCommMessageSentEvent)
                {
                    ...
                    setTimeout(function() {
                        try {
                            ...
                            console.error("PrivateJainSipClientConnector:onJainSipClientConnectorSipResponseEvent(): catched exception in event listener:"); console.log(exception);
                        }
                    }, 1);
                }
            }
            ...
            if (this.webRTCommMessage.webRTCommCall.eventListener.onWebRTCommMessageSendErrorEvent)
            {
                ...
                setTimeout(function() {
                    try {
                        ...
                        console.error("PrivateJainSipClientConnector:onJainSipClientConnectorSipTimeoutEvent(): catched exception in event listener:"); console.log(exception);
                    }
                }, 1);
            }
        }
...
PrivateJainSipCallConnector.prototype.close = function() {
    ...
    if (this.sipCallState !== undefined)
    {
        ...
        {
            console.error("PrivateJainSipCallConnector:close(): catched exception:"); console.log(exception);
            this.resetSipContext();
            this.clientConnector.removeSessionConnector(this.sipCallId);
            // Notify closed event
            this.webRTCommCall.onPrivateCallConnectorCallClosedEvent();
...
PrivateJainSipCallConnector.prototype.reject = function() {
    ...
    if (this.sipCallState === this.SIP_INVITED_INITIAL_STATE)
    {
        ...
        {
            console.error("PrivateJainSipCallConnector:reject(): catched exception:"); console.log(exception);
        }
        this.close();
    }
    else
...
PrivateJainSipCallConnector.prototype.processInvitingSipRequestEvent = function(requestEvent) {
    ...
    else if (this.sipCallState === this.SIP_INVITING_ACCEPTED_STATE)
    {
        if (requestMethod === "BYE")
        {
            ...
            {
                console.error("PrivateJainSipCallConnector:processInvitingSipRequestEvent(): catched exception exception:"); console.log(exception);
            }
...
PrivateJainSipCallConnector.prototype.processInvitedSipRequestEvent = function(requestEvent) {
    ...
    if (this.sipCallState === this.SIP_INVITED_INITIAL_STATE)
    {
        if (requestMethod === "INVITE")
        {
            ...
            {
                console.error("PrivateJainSipCallConnector:processInvitedSipRequestEvent(): catched exception, exception:"); console.log(exception);
            }
...
PrivateJainSipCallConnector.prototype.processInvitedSipResponseEvent = function(responseEvent) {
    ...
    else if (this.sipCallState === this.SIP_INVITED_LOCAL_HANGINGUP_STATE)
    {
        if (statusCode === 407)
        {
            ...
            {
                console.error("PrivateJainSipCallConnector:processInvitedSipResponseEvent(): catched exception, exception:"); console.log(exception);
                this.close();
            }
        }
        else
            ...
            if (this.openedFlag === false)
            {
                if (this.checkConfiguration(configuration) === true)
                {
                    ...
                    if (this.configuration.sipUriContactParameters)
                    {
                        ...
                        {
                            console.error("PrivateJainSipClientConnector:open(): catched exception:"); console.log(exception);
                        }
                    }
...
PrivateJainSipClientConnector.prototype.close = function() {
    ...
    try
    {
        ...
        console.error("PrivateJainSipClientConnector:close(): catched exception:"); console.log(exception);
        throw exception;
    }
};
...
PrivateJainSipClientConnector.prototype.createPrivateSessionConnector = function(webRTCommSession, sipSessionId) {
    ...
    try
    {
        ...
        console.error("PrivateJainSipClientConnector:createPrivateSessionConnector(): catched exception:"); console.log(exception);
        throw exception;
    }
};
...
PrivateJainSipClientConnector.prototype.checkConfiguration = function(configuration) {
    ...
    try
    {
        ...
        console.error("PrivateJainSipClientConnector:checkConfiguration(): catched exception:"); console.log(exception);
        return false;
    }
};
...
PrivateJainSipClientConnector.prototype.processConnected = function() {
    ...
    try
    {
        ...
        this.reset();
        this.webRTCommClient.onPrivateClientConnectorOpenErrorEvent();
        console.error("PrivateJainSipClientConnector:processConnected(): catched exception:"); console.log(exception);
    }
};
...
PrivateJainSipClientConnector.prototype.processDisconnected = function() {
    ...
    try
    {
        ...
        console.error("PrivateJainSipClientConnector:processDisconnected(): catched exception:"); console.log(exception);
    }
};
...
PrivateJainSipClientConnector.prototype.processConnectionError = function(error) {
    ...
    try
    {
        ...
        console.error("PrivateJainSipClientConnector:processConnectionError(): catched exception:"); console.log(exception);
    }
};
...
PrivateJainSipClientConnector.prototype.processRequest = function(requestEvent) {
    ...
    try
    {
        ...
        console.error("PrivateJainSipClientConnector:processRequest(): catched exception:"); console.log(exception);
    }
};
...
PrivateJainSipClientConnector.prototype.processResponse = function(responseEvent) {
    ...
    try
    {
        ...
        console.error("PrivateJainSipClientConnector:processResponse(): catched exception:"); console.log(exception);
    }
};
...
PrivateJainSipClientConnector.prototype.processIOException = function(exceptionEvent) {
    console.error("PrivateJainSipClientConnector:processIOException(): exceptionEvent="); console.log(exceptionEvent.message);
};
...
PrivateJainSipClientConnector.prototype.processTimeout = function(timeoutEvent) {
    ...
    try
    {
        ...
        console.error("PrivateJainSipClientConnector:processTimeout(): catched exception:"); console.log(exception);
    }
};
...
PrivateJainSipClientConnector.prototype.onSipRegisterTimeout = function() {
    ...
    try
    {
        ...
        console.error("PrivateJainSipClientConnector:onSipRegisterTimeout(): catched exception:"); console.log(exception);
    }
};
            ...
            if (this.checkConfiguration(configuration))
            {
                if (this.isOpened() === false)
                {
                    try
                    {
                        ...
                        console.error("WebRTCommCall:open(): catched exception:"); console.log(exception);
                        setTimeout(function() {
                            try {
                            ...
                            {
                                console.error("WebRTCommCall:open(): catched exception in listener:"); console.log(exception);
                            }
                        }, 1);
...
WebRTCommCall.prototype.close = function() {
    ...
    if (this.webRTCommClient.isOpened())
    {
		...
		this.dtmfSender = undefined;
            ...
            console.error("WebRTCommCall:close(): catched exception:"); console.log(exception);
        }
    }
    else
    {
            ...
            if (this.checkConfiguration(configuration))
            {
                ...
                if (this.isOpened() === false)
                {
                    try
                    {
                        ...
                        console.error("WebRTCommCall:accept(): catched exception:"); console.log(exception);
                        // Close properly the communication
                        try {
                            this.close();
                        } catch (e) {
...
WebRTCommCall.prototype.reject = function() {
    ...
    if (this.webRTCommClient.isOpened())
    {
        ...
        {
            console.error("WebRTCommCall:reject(): catched exception:"); console.log(exception);
            // Close properly the communication
            try {
                this.close();
            } catch (e) {
...
//                            }
//                            catch (exception) {
//                                console.error("PrivateJainSipClientConnector:processMessageSipRequestEvent(): catched exception in event listener:"); console.log(exception);
//                            }
//                        }, 1);
//                    }
//                }
//                catch (exception)
//                {
//                    console.error("WebRTCommCall:sendMessage(): catched exception:"); console.log(exception);
//                    throw "WebRTCommCall:sendMessage(): catched exception:"); console.log(exception;
//                }
//            }
//            else
//            {
...
WebRTCommCall.prototype.onPrivateCallConnectorRemoteSdpAnswerEvent = function(remoteSdpAnswer) {
    ...
    {
        console.error("WebRTCommCall:onPrivateCallConnectorRemoteSdpAnswerEvent(): catched exception:"); console.log(exception);
        throw exception;
    }
};
...
WebRTCommCall.prototype.onPrivateCallConnectorCallOpenedEvent = function()
{
    ...
    if (this.eventListener.onWebRTCommCallOpenEvent)
    {
        ...
        setTimeout(function() {
            ...
            {
                console.error("WebRTCommCall:onPrivateCallConnectorCallOpenedEvent(): catched exception in listener:"); console.log(exception);
            }
        }, 1);
    }
};
...
WebRTCommCall.prototype.onPrivateCallConnectorCallInProgressEvent = function()
{
    ...
    if (this.eventListener.onWebRTCommCallInProgressEvent)
    {
        ...
        setTimeout(function() {
            ...
            {
                console.error("WebRTCommCall:onPrivateCallConnectorCallInProgressEvent(): catched exception in listener:"); console.log(exception);
            }
        }, 1);
    }
};
...
WebRTCommCall.prototype.onPrivateCallConnectorCallOpenErrorEvent = function(error)
{
    ...
    if (this.eventListener.onWebRTCommCallOpenErrorEvent)
    {
        ...
        setTimeout(function() {
            ...
            {
                console.error("WebRTCommCall:onPrivateCallConnectorCallOpenErrorEvent(): catched exception in listener:"); console.log(exception);
            }
        }, 1);
    }
};
...
WebRTCommCall.prototype.onPrivateCallConnectorCallRingingEvent = function(callerPhoneNumber, callerDisplayName)
{
    ...
    if (this.eventListener.onWebRTCommCallRingingEvent)
    {
        ...
        setTimeout(function() {
            ...
            {
                console.error("WebRTCommCall:onPrivateCallConnectorCallRingingEvent(): catched exception in listener:"); console.log(exception);
            }
        }, 1);
    }
};
...
WebRTCommCall.prototype.onPrivateCallConnectorCallRingingBackEvent = function()
{
    ...
    if (this.eventListener.onWebRTCommCallRingingBackEvent)
    {
        ...
        setTimeout(function() {
            ...
            {
                console.error("WebRTCommCall:onPrivateCallConnectorCallRingingBackEvent(): catched exception in listener:"); console.log(exception);
            }
        }, 1);
    }
};
...
WebRTCommCall.prototype.onPrivateCallConnectorCallHangupEvent = function()
{
    ...
    if (this.eventListener.onWebRTCommCallHangupEvent)
    {
        ...
        setTimeout(function() {
            ...
            {
                console.error("WebRTCommCall:onPrivateCallConnectorCallHangupEvent(): catched exception in listener:"); console.log(exception);
            }
        }, 1);
    }
};
...
WebRTCommCall.prototype.onRtcPeerConnectionErrorEvent = function(error) {
    ...
    if (this.eventListener.onWebRTCommCallOpenErrorEvent)
    {
        ...
        setTimeout(function() {
            ...
            {
                console.error("WebRTCommCall:onRtcPeerConnectionErrorEvent(): catched exception in listener:"); console.log(exception);
            }
        }, 1);
    }
...
WebRTCommCall.prototype.onRtcPeerConnectionOnAddStreamEvent = function(event) {
    try
    {
	    ...
	    // https://code.google.com/p/webrtcomm/issues/detail?id=22 Make sure to call WebRTCommCall on add stream event
			...
			if (that.peerConnection.createDTMFSender) {
                    ...
                    {
                        console.error("WebRTCommCall:onRtcPeerConnectionOnAddStreamEvent(): catched exception in listener:"); console.log(exception);
                    }
                }, 1);
            }
        }
    ...
    {
        console.error("WebRTCommCall:onRtcPeerConnectionOnAddStreamEvent(): catched exception, exception:"); console.log(exception);
...
WebRTCommCall.prototype.onRtcPeerConnectionOnRemoveStreamEvent = function(event) {
    ...
    {
        console.error("WebRTCommCall:onRtcPeerConnectionOnRemoveStreamEvent(): catched exception, exception:"); console.log(exception);
        this.onRtcPeerConnectionErrorEvent();
    }
};
...
WebRTCommCall.prototype.onRtcPeerConnectionIceCandidateEvent = function(rtcIceCandidateEvent) {
                        ...
                        else if (this.peerConnectionState === 'preparing-answer')
                        {
                            ...
                            if (this.eventListener.onWebRTCommCallOpenedEvent)
                            {
                                ...
                                setTimeout(function() {
                                    ...
                                    {
                                        console.error("WebRTCommCall:onRtcPeerConnectionIceCandidateEvent(): catched exception in listener:"); console.log(exception);
                                    }
                                }, 1);
                            }
                        }
    ...
    {
        console.error("WebRTCommCall:onRtcPeerConnectionIceCandidateEvent(): catched exception, exception:"); console.log(exception);
...
WebRTCommCall.prototype.onRtcPeerConnectionCreateOfferSuccessEvent = function(sdpOffer) {
    ...
    {
        console.error("WebRTCommCall:onRtcPeerConnectionCreateOfferSuccessEvent(): catched exception, exception:"); console.log(exception);
        this.onRtcPeerConnectionErrorEvent();
    }
};
...
WebRTCommCall.prototype.onRtcPeerConnectionCreateOfferErrorEvent = function(error) {
    ...
    {
        console.error("WebRTCommCall:onRtcPeerConnectionCreateOfferErrorEvent(): catched exception, exception:"); console.log(exception);
        this.onRtcPeerConnectionErrorEvent();
    }
};
...
WebRTCommCall.prototype.onRtcPeerConnectionSetLocalDescriptionSuccessEvent = function() {
                ...
                else if (this.peerConnectionState === 'preparing-answer')
                {
                    ...
                    if (this.eventListener.onWebRTCommCallOpenedEvent)
                    {
                        ...
                        setTimeout(function() {
                            ...
                            {
                                console.error("WebRTCommCall:onRtcPeerConnectionSetLocalDescriptionSuccessEvent(): catched exception in listener:"); console.log(exception);
                            }
                        }, 1);
                    }
                }
    ...
    {
        console.error("WebRTCommCall:onRtcPeerConnectionSetLocalDescriptionSuccessEvent(): catched exception, exception:"); console.log(exception);
        this.onRtcPeerConnectionErrorEvent();
    }
};
...
WebRTCommCall.prototype.onRtcPeerConnectionSetLocalDescriptionErrorEvent = function(error) {
    ...
    {
        console.error("WebRTCommCall:onRtcPeerConnectionSetLocalDescriptionErrorEvent(): catched exception, exception:"); console.log(exception);
        this.onRtcPeerConnectionErrorEvent();
    }
};
...
WebRTCommCall.prototype.onRtcPeerConnectionCreateAnswerSuccessEvent = function(sdpAnswser) {
    ...
    {
        console.error("WebRTCommCall:onRtcPeerConnectionCreateAnswerSuccessEvent(): catched exception, exception:"); console.log(exception);
        this.onRtcPeerConnectionErrorEvent();
    }
};
...
WebRTCommCall.prototype.onRtcPeerConnectionCreateAnswerErrorEvent = function(error) {
    ...
    {
        console.error("WebRTCommCall:onRtcPeerConnectionCreateAnswerErrorEvent(): catched exception, exception:"); console.log(exception);
        this.onRtcPeerConnectionErrorEvent();
    }
};
...
WebRTCommCall.prototype.onRtcPeerConnectionSetRemoteDescriptionSuccessEvent = function() {
		...
		console.debug("WebRTCommCall:onRtcPeerConnectionSetRemoteDescriptionSuccessEvent(): this.peerConnectionState=" + this.peerConnectionState);
                ...
                if (this.eventListener.onWebRTCommCallOpenedEvent)
                {
                    ...
                    setTimeout(function() {
                        ...
                        {
                            console.error("WebRTCommCall:onRtcPeerConnectionSetRemoteDescriptionSuccessEvent(): catched exception in listener:"); console.log(exception);
                        }
                    }, 1);
                }
            }
    ...
    {
        console.error("WebRTCommCall:onRtcPeerConnectionSetRemoteDescriptionSuccessEvent(): catched exception, exception:"); console.log(exception);
        this.onRtcPeerConnectionErrorEvent();
    }
};
                    ...
                    else if (this.peerConnectionState === 'preparing-answer')
                    {
                        ...
                        if (this.eventListener.onWebRTCommCallOpenedEvent)
                        {
                            ...
                            setTimeout(function() {
                                ...
                                {
                                    console.error("WebRTCommCall:onRtcPeerConnectionGatheringChangeEvent(): catched exception in listener:"); console.log(exception);
                                }
                            }, 1);
                        }
                    }
        ...
        if (this.messageChannel)
        {
            ...
            if (this.eventListener.onWebRTCommMessageReceivedEvent)
            {
                ...
                setTimeout(function() {
                    ...
                    {
                        console.error("WebRTCommCall:onRtcPeerConnectionMessageChannelOnMessageEvent(): catched exception in listener:"); console.log(exception);
                    }
                }, 1);
            }
        }
...
WebRTCommCall.prototype.applyConfiguredCodecFilterOnSessionDescription = function(sessionDescription) {
    if (sessionDescription instanceof SessionDescription)
    {
        ...
        {
            console.error("WebRTCommCall:applyConfiguredCodecFilterOnSessionDescription(): catched exception, exception:"); console.log(exception);
            throw exception;
        }
    }
    else
...
WebRTCommCall.prototype.patchChromeIce = function(sessionDescription, attributeToCheck) {
    ...
    if (sessionDescription instanceof SessionDescription)
    {
        ...
        {
            console.error("WebRTCommCall:patchChromeIce(): catched exception, exception:"); console.log(exception);
            throw exception;
        }
    }
    else
...
WebRTCommCall.prototype.removeMediaDescription = function(sessionDescription, mediaTypeToRemove) {
    ...
    if (sessionDescription instanceof SessionDescription)
    {
        ...
        {
            console.error("WebRTCommCall:removeMediaDescription(): catched exception, exception:"); console.log(exception);
            throw exception;
        }
    }
    else
...
WebRTCommCall.prototype.forceTurnMediaRelay = function(sessionDescription) {
    ...
    if (sessionDescription instanceof SessionDescription)
    {
        ...
        {
            console.error("WebRTCommCall:forceTurnMediaRelay(): catched exception, exception:"); console.log(exception);
            throw exception;
        }
    }
    else
...
WebRTCommClient.prototype.close = function() {
    ...
    if (this.isOpened())
    {
        try
        {
            ...
            console.error("WebRTCommClient:close(): catched exception:"); console.log(exception);
            ...
            if (this.eventListener.onWebRTCommClientClosedEvent !== undefined)
            {
                ...
                setTimeout(function() {
                    ...
                    {
                        console.error("WebRTCommClient:onWebRTCommClientClosed(): catched exception in event listener:"); console.log(exception);
                    }
                }, 1);
            }
        }
...
WebRTCommClient.prototype.sendMessage = function(to, text)
{
    ...
    {
        console.error("WebRTCommClient:sendMessage(): catched exception:"); console.log(exception);
...
WebRTCommClient.prototype.call = function(calleePhoneNumber, callConfiguration) {
    ...
    try
    {
        ...
        console.error("WebRTCommClient:call(): catched exception:"); console.log(exception);
        throw exception;
    }
};
    ...
    if (this.eventListener.onWebRTCommClientOpenedEvent !== undefined)
    {
        ...
        setTimeout(function() {
            try {
                ...
                console.error("WebRTCommClient:onPrivateClientConnectorOpenedEvent(): catched exception in event listener:"); console.log(exception);
            }
        }, 1);
    }
};
    ...
    if (this.eventListener.onWebRTCommClientOpenErrorEvent !== undefined)
    {
        ...
        setTimeout(function() {
            try {
                ...
                console.error("WebRTCommClient:onPrivateClientConnectorOpenErrorEvent(): catched exception in event listener:"); console.log(exception);
            }
        }, 1);
    }
};
    ...
    if (wasOpenedFlag && (this.eventListener.onWebRTCommClientClosedEvent !== undefined))
    {
        ...
        setTimeout(function() {
            try {
                ...
                console.error("WebRTCommClient:onPrivateClientConnectorClosedEvent(): catched exception in event listener:"); console.log(exception);
            }
        }, 1);
    }
    else if (!wasOpenedFlag && (this.eventListener.onWebRTCommClientOpenErrorEvent !== undefined))
    {
        ...
        setTimeout(function() {
            try {
                ...
                console.error("WebRTCommClient:onWebRTCommClientOpenErrorEvent(): catched exception in event listener:"); console.log(exception);
            }
        }, 1);
    }
};
