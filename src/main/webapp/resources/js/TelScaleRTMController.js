...
MobicentsWebRTCPhoneController.prototype.DEFAULT_TURN_LOGIN="deruelle"; 
MobicentsWebRTCPhoneController.prototype.DEFAULT_TURN_PASSWORD="bec47bdc-3257-4b84-b992-de9cf5e96dee"; 
...
MobicentsWebRTCPhoneController.prototype.DEFAULT_LOCAL_VIDEO_FORMAT="{}";
...
MobicentsWebRTCPhoneController.prototype.onGetUserMediaErrorEventHandler=function(error) 
{
    ...
    modal_alert("<i class='glyphicon glyphicon-facetime-video'></i> Failed to get local user media. Make sure you have granted the rights to the webcam and/or microphone!");
}	
 ...
 */ 
MobicentsWebRTCPhoneController.prototype.onClickCallButtonViewEventHandler=function(calleePhoneNumber,videoCall)
{
    ...
    if(this.webRTCommCall == undefined)
    {
        try
        {
            ...
            this.view.enableEndCallButton(calleePhoneNumber,videoCall);
 ...
 */ 
MobicentsWebRTCPhoneController.prototype.onClickAcceptCallButtonViewEventHandler=function(videoCall)
{
    console.debug ("MobicentsWebRTCPhoneController:onClickAcceptCallButtonViewEventHandler() : " + videoCall); 
    if(this.webRTCommCall)
    {
        try
        {
...
//    this.view.disableDisconnectButton();
    this.view.enableEndCallButton(webRTCommCall.getCalleePhoneNumber(),webRTCommCall.getConfiguration().videoMediaFlag);
    this.view.enableEndCallButton(webRTCommCall.getCallerPhoneNumber(),webRTCommCall.getConfiguration().videoMediaFlag);
//    this.view.disableDisconnectButton();
//    this.view.disableConnectButton();
    //this.view.disableCancelCallButton();
    ...
    {
	console.debug ("MobicentsWebRTCPhoneController:onWebRTCommCallOpenedEvent(): webRTCommCall.getRemoteBundledAudioVideoMediaStream()="+webRTCommCall.getRemoteBundledAudioVideoMediaStream()); 
    ...
    else
    {
        ...
        {
	    	console.debug ("MobicentsWebRTCPhoneController:onWebRTCommCallOpenedEvent(): webRTCommCall.getRemoteAudioMediaStream()="+webRTCommCall.getRemoteAudioMediaStream()); 
	    this.view.showRemoteVideo(webRTCommCall.getCalleePhoneNumber());
	    this.view.showRemoteVideo(webRTCommCall.getCallerPhoneNumber());
            this.view.playRemoteVideo(webRTCommCall.getCalleePhoneNumber(), webRTCommCall.getRemoteAudioMediaStream());
	    this.view.playRemoteVideo(webRTCommCall.getCallerPhoneNumber(), webRTCommCall.getRemoteAudioMediaStream());
        } 
        if(webRTCommCall.getRemoteVideoMediaStream())
        {
	console.debug ("MobicentsWebRTCPhoneController:onWebRTCommCallOpenedEvent(): webRTCommCall.getRemoteVideoMediaStream()="+webRTCommCall.getRemoteVideoMediaStream()); 
            this.view.showRemoteVideo(webRTCommCall.getCalleePhoneNumber());
	    this.view.showRemoteVideo(webRTCommCall.getCallerPhoneNumber());
            this.view.playRemoteVideo(webRTCommCall.getCalleePhoneNumber(), webRTCommCall.getRemoteVideoMediaStream());
	    this.view.playRemoteVideo(webRTCommCall.getCallerPhoneNumber(), webRTCommCall.getRemoteVideoMediaStream());
        } 
    }

    selectContact(webRTCommCall.getCalleePhoneNumber());
    selectContact(webRTCommCall.getCallerPhoneNumber());
    performStartCallActions();
...
//    this.view.disableConnectButton();
    ...
    $('#incCallName').text(webRTCommCall.getCallerPhoneNumber());
    $('#incomingCall').show();
...
MobicentsWebRTCPhoneController.prototype.sendDTMF = function(dtmfEvent) {
	this.webRTCommCall.sendDTMF(dtmfEvent);
}
